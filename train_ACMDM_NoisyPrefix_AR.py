...
from models.ACMDM_NoisyPrefix_AR import ACMDM_models
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, default='ACMDM_NoisyPrefixAR_Flow_S_PatchSize22')
    ...
    parser.add_argument('--model', type=str, default='ACMDM-NoisyPrefixAR-Flow-S-PatchSize22')
