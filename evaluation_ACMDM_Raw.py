...
def main(args):
    ...
    ema_acmdm = ACMDM_models[args.model](input_dim=dim_pose, cond_mode='text')
    ...
    for i in range(repeat_time):
        with torch.no_grad():
            ...
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, best_mm, clip_score, writer, save_now, _, _, _ = evaluation_acmdm(
                model_dir, eval_loader, ema_acmdm, None, None, i, best_fid=best_fid, clip_score_old=clip_score,
                best_div=best_div, best_top1=best_top1, best_top2=best_top2, best_top3=best_top3,
                best_matching=best_matching, eval_wrapper=eval_wrapper, device=device, eval_mean=eval_mean, eval_std=eval_std,
                after_mean=None, after_std=None,
                cond_scale=args.cfg, cal_mm=args.cal_mm, is_raw=True,
                draw=False)
        fid.append(best_fid)
        div.append(best_div)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='ACMDM-Raw-Flow-S-PatchSize22')
